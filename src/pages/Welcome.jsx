...
const Welcome = () => {
  return (
    ...
    <div className='h-screen w-screen flex flex-col bg-no-repeat bg-cover' style={{ backgroundImage: "url('https://bywjfszqwytcvsftccvd.supabase.co/storage/v1/object/public/Marathon/marathon-6660178_1280.jpg?t=2024-07-29T09%3A09%3A01.933Z')", filter: 'brightness(100%)' }}>
      ...
      <div className='text-center flex justify-center items-center opacity-800 text-white lg:text-4xl text:3xl  font-extrabold opacity-800 '>Celebration Norton Metro</div>
      <div className='text-center flex justify-center items-center opacity-800 text-white lg:text-4xl text:3xl font-extrabold opacity-800 '>2024 Fun Run Registration Platform</div>
