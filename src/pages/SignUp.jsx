...
const supabase = createClient('https://ionvxvmrvedvjclzwgik.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlvbnZ4dm1ydmVkdmpjbHp3Z2lrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDg2MjIxMjcsImV4cCI6MjAyNDE5ODEyN30.t-ooYg6C3EYcObdGPBzl95-i_nuyvCx8fDM9w-OQ7MI');
const SignUp = () => {
