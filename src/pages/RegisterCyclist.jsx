...
const RegisterCyclist = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data, error } = await supabase.from('cyclist').insert([{ Name, Surname, Email, Mobile, Age, NextOfKin, Racetype, Gender, Tshirt }]);
      if (error) {
          throw error;
      }
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/90 backdrop-blur-lg shadow-xl rounded-2xl w-full max-w-4xl p-8">
        ...
        <p className="text-center text-gray-600 mb-6">Please fill out the cyclist registration form below</p>
