...
const RegisterFacilitator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data, error } = await supabase.from('Facilitator').insert([{ Name, Surname, Email, Mobile, MaritalStatus, Church, Age, Address}]);
      if (error) {
          throw error;
      }
...
export default RegisterFacilitator;